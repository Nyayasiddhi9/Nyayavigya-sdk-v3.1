# NyayaVighya SDK v10.0 - Agent Definition Guide

## Overview

This document provides comprehensive guidance for defining, modifying, and adding new agents to the NyayaVighya SDK 267-agent ecosystem. All agents must follow the **22-point system prompt framework** and adhere to ROMA (L1-L4) autonomy levels.
