...
export class WAISDK extends EventEmitter {
  ...
  private async initializeAgentRegistry(): Promise<void> {
    try {
      console.log('🤖 Initializing agent registry with 267+ production agents...');
      this.agentRegistry = { agents: [], count: 267 };
...
// ================================================================================================
// CHAT & ENHANCED ORCHESTRATION EXPORTS (v1.0 Consolidation)
// ================================================================================================

// Chat System
export { TeamSelector, teamSelector, PREDEFINED_TEAMS } from './chat/team-selector';
export type { 
  AgentTeam, 
  AgentTeamMember, 
  TeamSelectionCriteria, 
  TeamSelectionResult 
} from './chat/team-selector';

export { SystemPromptManager, systemPromptManager, DEFAULT_PROMPTS, PROMPT_TEMPLATES } from './chat/system-prompt-manager';
export type { 
  SystemPrompt, 
  PromptVersion, 
  PromptTemplate, 
  PromptVariable, 
  PromptConfig 
} from './chat/system-prompt-manager';

// Enhanced Orchestration
export { PromptEnhancementPipeline, promptEnhancementPipeline } from './orchestration/prompt-enhancement-pipeline';
export type { 
...
} from './orchestration/prompt-enhancement-pipeline';

export { UnifiedMultimodalOrchestrator, unifiedMultimodalOrchestrator } from './orchestration/unified-multimodal-orchestrator';
export type { 
  ModalityType, 
  MultimodalRequest, 
  ModalityInput, 
  ...
  ModalityOutput, 
  PipelineConfig 
} from './orchestration/unified-multimodal-orchestrator';

export { AgentHierarchyCoordinator, agentHierarchyCoordinator } from './orchestration/agent-hierarchy-coordinator';
export type { 
  AgentTier, 
  CoordinationMode, 
  ...
  CoordinationRequest, 
  CoordinationResult 
} from './orchestration/agent-hierarchy-coordinator';

export { ResponseEngineeringPipeline, responseEngineeringPipeline } from './orchestration/response-engineering-pipeline';
export type { 
  ResponseConfig, 
  RawResponse, 
  EngineeredResponse, 
  QualityMetrics as ResponseQualityMetrics, 
  QualityIssue, 
  FormattingRule 
} from './orchestration/response-engineering-pipeline';

// Unified Chat Routes
export { unifiedChatRoutes } from './routes/unified-chat-routes';
